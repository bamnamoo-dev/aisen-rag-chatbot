...
def route_query_by_keywords(query, categories, return_candidates=False):
    ...
    category_keywords = {
        ...
        "지출": ["지출", "품의", "결의", "정산", "법인카드", "영수증", "지출결의", "여비정산", "대금", "카드", "카드결제", "증빙", "원천징수", "세금계산서", "지급", "기안", "반납", "업무추진비", "협의회비", "추진비", "회비", "운영비", "사업비", "급량비", "수수료", "비용", "판공비", "여비", "간식비", "식비", "매식비", "특근매식비", "생일", "생일기념", "경조사비", "피복비"],
        "세입": ["세입", "수입", "수수료", "징수", "반환", "수납", "고지서", "연납"],
        "교행지원사례집": ["사례집", "교행지원", "질문답변", "질의응답", "질문답변사례집", "질의응답사례집", "사례", "교행지원시스템"]
    }
